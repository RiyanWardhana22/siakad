<div class="main-sidebar sidebar-style-2">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="dropdown">
        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fa fa-user" aria-hidden="true"></i> <span>Dosen</span></a>
      ...
      <li class="dropdown">
        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fa fa-address-card-o" aria-hidden="true"></i><span>Mahasiswa</span></a>
        <ul class="dropdown-menu">
