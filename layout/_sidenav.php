<div class="main-sidebar sidebar-style-2">
  <aside id="sidebar-wrapper">
    ...
    <div class="sidebar-brand sidebar-brand-sm">
      <a href="index.php">RW</a>
    </div>
    <ul class="sidebar-menu">
      <li class="menu-header">Dashboard</li>
      <li><a class="nav-link" href="../dashboard/"><i class="fa fa-home"></i><span>Home</span></a></li>
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a class="nav-link" href="../nilai/">◉ Kartu Hasil Studi(KHS)</a></li>
        </ul>
      </li>
    </ul>
  </aside>
